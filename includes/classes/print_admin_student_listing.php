<?php
//$_SESSION['teacherLoginInfo']=1;
//echo $_SESSION['LoginInfo']['USERID'].'--------';
//echo '<pre>';print_r($_SESSION['LoginInfo']);
...
<div class="main_wrapper" id="mid_wrapper">
    <div class="full_width_page">
        ...
        <div id="page_content">
            ...
            <!-- My Profile -->
            <div id="gallery">
                <div id="title_teacher_login"><h2><!--<?php echo $studentList['0']['class_code'] ?> Student Listing-->Attendance and Roster</h2></div>
