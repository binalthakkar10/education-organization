...
class Category 
{
	...
	function showAllCategory()
	{
        ...
        function showAllCategoryMy()
	{
		$sql="select *  from itf_category_type where status='1' order by catname";

		return $this->dbcon->FetchAllResults($sql);
	}
	
        
         function showAllPriceCategory()
	{
		$sql="select *  from itf_price_type where status='1' order by price_type";
		return $this->dbcon->FetchAllResults($sql);
	}
