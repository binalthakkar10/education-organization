...
//echo strtotime($classDetail['installment_start_date']).'<br>'.strtotime('+ 30 days').'<br>'.strtotime("2014-9-7");
    ...
    <div class="full_width_page">
        ...
        <div id="page_content">
            ...
            <div class="class_listing_bottom">
                <div id="title"><h1>Classes</h1></div>
                <div id="table_listing">
                    <table cellpadding="0" cellspacing="0" border="1">
                        <tbody>
                            ...
                            <tr>
                                <th>Start Time</th>
                                <td><?php echo $classDetail['class_time']; ?></td>
                            </tr>
                            <tr>
                                <th>Start Date</th>
                            ...
                            <?php if ($classDetail['registration_type'] != 'external') {
                                ?>
                                <tr>
                                ...
                                <?php if ($classDetail['installment_booking_amt'] != '0.00' && $classDetail['registration_type'] != 'external') {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            First Installment (Pay Now): <?php echo $stieinfo['currency_prefix'] . $classDetail['installment_booking_amt'] ?><br/>
                    ...
                    <div id="btn_button">
                        ...
                        if ($classDetail['registration_type'] == 'external') {
                            ...
                            echo '<a class="button_btn_all" href="' . $classDetail['link'] . '" target="_blank">Register</a>';
                        } else {
                            ?>
                            <a class="button_btn_all" href="index.php?itfpage=student&type=ererre123e&class_id=<?php echo $iDs ?>" >Register</a>
