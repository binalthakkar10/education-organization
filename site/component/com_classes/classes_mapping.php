...
if ($_REQUEST['grade'] != '') {
    ...
    $searchCriteria['registration_type']='1';
}
 $locDetails = $locationObj->getLocationDetailForMap($searchCriteria);
            ...
            <p><?php echo $pageDetails['logn_desc'] ?></p> <div class="registration">
                <div id="registration_top">
                    <form name="frm" id="frm" method="post" action="" class="map_cl">
                        <div class="mapbox">
                            <span>Show Classes by Grade</span>
                            <span>
                    ...
                    <div style="text-align:left;" class="class_list_link"><a href="index.php?itfpage=classes&itemid=classes_listing">List of all Classes</a></div>
                </div>
                <div id="registration_bottom">  <div id="map" style=" margin: auto;"></div></div>
            </div>
        </div>
    </div>
</div>
