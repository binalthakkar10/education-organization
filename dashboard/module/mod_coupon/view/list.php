...
<div class="full_w">
    ...
    <?php /*?><form id="itffrmsearch" name="itffrmsearch" method="post" action="">
    ...
    <table>
        <thead>
            <tr>
                ...
                <th  class="align-left" scope="col">Name</th>
                <th  class="align-left" scope="col">Code</th>
                <th  class="align-left" scope="col">Scope</th>
                <th  class="align-left" scope="col">Start Date</th>
                <th  class="align-left" scope="col">End Date</th>
                ...
                for ($i = 0; $i < count($InfoData); $i++) {
                    ...
                    <tr>
                       ...
                       <!-- <td class="align-left"><?php echo $InfoData[$i]['course']; ?></td>--> 
                        ...
                        <td class="align-left"><?php echo ucfirst($InfoData[$i]['scope']); ?></td>
                        <td class="align-left"><?php echo $InfoData[$i]['start_date']; ?></td>
                        <td class="align-left"><?php echo $InfoData[$i]['end_date']; ?></td>
                        <td class="align-left"><?php if($InfoData[$i]['status'] == 1) { echo "Enable";} else {"Disable"; } ?></td>
                       <!-- <td class="align-left"><?php echo $InfoData[$i]['zip']; ?></td>
                        ...
                        <td class="align-center">
                            <a href="<?php echo CreateLinkAdmin(array($currentpagenames, 'actions' => 'edit',  'id' => $InfoData[$i]['id'])); ?>" title="Edit <?php echo $pagetitle; ?> " alt="Edit <?php echo $pagetitle; ?>"><img src="img/i_edit.png" border="0" /></a> &nbsp;
