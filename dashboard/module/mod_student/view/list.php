...
$InfoData1 = $objstudent->SearchStudent($_REQUEST);
...
//$cityName = $objstudent->getActiveCity();
...
<div class="full_w">
    ...
    <div class="table">
        <a href="<?php echo CreateLinkAdmin(array('report', 'actions' => 'export', 'type' => 1, 'requestFrom' => 'admin')); ?>">Download Student Data</a>
                ...
                if (isset($InfoData) and $InfoData != null) {
                    for ($i = 0; $i < count($InfoData); $i++) {
                        ...
                        <tr class="<?php echo ($i % 2 == 0) ? "odd" : ""; ?>" >
                            ...
                            <td align="center"><a href="<?php echo CreateLinkAdmin(array($currentpagenames, 'actions' => 'edit', 'id' => $InfoData[$i]['id'])); ?>" title="Edit User" alt="Edit User"><img src="img/i_edit.png" border="0" /></a></td>
                        </tr>
                        <?php
                    }
                } else {
                    echo ("<tr> <td colspan=\"10\" align=center>Search data does not exists! Please try again.</td></tr>");
                }
                ?>
            </table>
        </form>
