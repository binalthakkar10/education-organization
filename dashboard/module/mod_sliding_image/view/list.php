...
if (isset($_POST['itf_datasid'], $_POST['itfactions'])) {
    ...
    if ($acts == 'delete') {
        $objSlidingImage->Banner_deleteAdmin($ids);
...
$InfoData1 = $objSlidingImage->showAllSlidingImage();
    ...
    <form id="itffrmlists" name="itffrmlists" method="post" action="">
        ...
        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <th width="20%" align="left">Sequence </th>
            ...
            foreach ($InfoData as $k => $itfdata) {
                ...
                <tr class="<?php echo ($k % 2 == 0) ? "rowsfirst" : "rowssec"; ?>" >
                    ...
                    <td  align="left" ><?php echo $itfdata['position']; ?></td> 
                    <td align="left" class=""><img src="<?php echo PUBLICPATH . "banner/" . $itfdata['image_name']; ?>" width="25" height="25"  /></td>
