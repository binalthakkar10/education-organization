...
$partnerName = $obj->ShowAllPartner();
        ...
        <?php } ?>
          ...
          <div class="element">
            <label>Partner Name<span class="red">(required)</span></label>
                ...
                <?php foreach ($partnerName as $item) { ?>
                    <option value="<?php echo $item['id']; ?>"   <?php if ($InfoData['partner_id'] == $item['id']) { ?>selected="selected"<?php } ?>><?php echo $item['partner_name']; ?> </option>
                <?php } ?>
            </select>
             </div>
        <div class="element">
