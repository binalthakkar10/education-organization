...
echo $InfoData1 = $obj->showAllCamp($parentids);
                ...
                for($i=0;$i<count($InfoData);$i++)
                {
                    ...
                    <tr>
                        <td class="align-center"><input name="itf_datasid[]" type="checkbox" value="<?php echo $InfoData[$i]['id']; ?>" class="itflistdatas"/></td>
                         <td class="align-left"><?php echo $InfoData[$i]['camp_for']; ?></td>
                        <td class="align-left"><?php echo $InfoData[$i]['program_name']; ?></td>
                        <td class="align-left"><?php echo $InfoData[$i]['age_group']; ?></td>
                        <td class="align-left"><?php echo $InfoData[$i]['duration']; ?></td>
                        <td class="align-left"><?php echo $InfoData[$i]['base_fee']; ?></td>
