...
<div class="full_w">
    ...
    <form action="" method="post" name="itffrminput" id="itffrminput" enctype="multipart/form-data">
        ...
        <div class="element">
            <label><span class="blue">Notice: File header must be named as <?php echo implode(", ", array_keys($validate_fields)); ?> [ And dob, attende_date should be Y-m-d format like(2014-10-30) ] </span></label>
        </div>
        <div class="element">
