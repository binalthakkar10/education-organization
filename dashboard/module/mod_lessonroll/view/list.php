...
if(isset($_POST['itf_datasid'],$_POST['itfactions']))
{
	...
	if($acts=='delete')
	{
		...
		flash("University is successfully Deleted");
	}
...
<input type="hidden" name="itf_status" id="itf_status" value="" />
  <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <th width="37%" align="left"  >University Name </th>
       <th width="20%" align="left"  >University Id </th>
       <th width="20%" align="left"  >Product Key</th>
   	<th width="37%" align="left"  >Check Exam Result</th>
    ...
    <tr class="<?php echo ($k%2==0)?"rowsfirst":"rowssec";?>" >
      <td align="left"><input name="itf_datasid[]" type="checkbox" value="<?php echo $itfdata['id']; ?>" class="itflistdatas" /></td>
	   <td  align="left" ><?php echo $itfdata['title']; ?></td>
           <td  align="left" ><?php echo $itfdata['uni_id']; ?></td>
            <td  align="left" ><?php echo $itfdata['product_key']=="1" ?"Activate":'Disable' ?></td>
             <td  align="left" ><?php echo $itfdata['chk_exam_result']=="1" ?"Activate":'Disable' ?></td>
     
       <td align="center"><a href="#itf" class="activations" rel="<?php echo $itfdata['id']; ?>" rev="frmuniversity"><img src="imgs/<?php echo $itfdata['status']; ?>.png" /></a></td>
   <td align="center">
