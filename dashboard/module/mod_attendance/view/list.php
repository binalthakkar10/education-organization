...
<div class="full_w">
    ...
    <a href="itfmain.php?itfpage=report&actions=export&requestFrom=attendance<?php echo isset($_REQUEST['loc_id']) ? '&loc_id='.$_REQUEST['loc_id'] : '' ?><?php echo isset($_REQUEST['course']) ? '&course='.$_REQUEST['course'] : '' ?><?php echo isset($_REQUEST['classCode']) ? '&classCode='.$_REQUEST['classCode'] : '' ?>">Download in Excel Format</a>
</div>
<div class="clear"></div>
