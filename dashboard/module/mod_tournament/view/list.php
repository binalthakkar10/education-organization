...
if (isset($_REQUEST['txtsearch']) and !empty($_REQUEST['txtsearch'])) {
    ...
    $InfoData1 = $userobj->ShowAllTournaments();
}
...
<div class="full_w">
    ...
    <div class="clear"></div>
   <a href="<?php echo CreateLinkAdmin(array('report', 'actions' => 'export', 'type' => 1, 'requestFrom' => 'Tournament')); ?>">Download Student Data</a>
    ...
    for ($i = 0; $i < count($InfoData); $i++) {
        ?>
                        <tr>
                            ...
                            <td class="align-left">
                                <a href="itfmain.php?itfpage=tournament&actions=studentlist&id=<?php echo $InfoData[$i]['id']?>">
                        <?php echo $InfoData[$i]['title']; ?>
                                </a></td>

                            <td class="align-center">
                                <a href="#itf" class="activations" rel="<?php echo $InfoData[$i]['id']; ?>" rev="tournament"><img src="imgs/<?php echo $InfoData[$i]['status']; ?>.png" /></a>
                            </td>
