                ...
                <div id="table_listing">
                    <table cellpadding="0" cellspacing="0" border="1">
                        <tbody>
                            ...
                            <tr>
                                <th>Fees</th>
                                <td><?php echo $stieinfo['currency_prefix'] .$classDetail['single_pay_amt'] ?></td>
                            </tr>
                            <tr>
                    ...
                    if ($classDetail['registration_type'] == 'external') {
                        ...
                        ?>
                        <div id="btn_button"><a class="button_btn_all" href="index.php?itfpage=student&type=2&class_id=<?php echo $classDetail['class_id'] ?>">Register</a></div>
