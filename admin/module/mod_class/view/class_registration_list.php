...
Version 1.1 - 6/17/16 - Enhancement #9 - Add date/day/type in Class registration page
*/
...
$urlpath = CreateLinkAdmin(array($currentpagenames, "parentid" => $parentids, "actions"=>'class_registration_list')) . "&";
//echo "list1";
$courobj = new Course();
if ($_GET['show'] == 'all') {
...
///
$classRstatus = $obj->ShowAllClassRegisterStatus();
////
?>
<script>
    function closedClass(val)
    {
        ...
        if (x == true)
        {
            urlLink = 'itfmain.php?itfpage=class&actions=class_registration_list&show=all&';
        }
        else
        {
            urlLink = 'itfmain.php?itfpage=class&actions=class_registration_list&';
        }
...
<div class="full_w">
    <!-- Page Heading -->
    <div class="h_title"><?php echo 'Class Registration List'; ?></div>
    <!-- Page Heading -->
    ...
    <form id="itffrmsearch" name="itffrmsearch" method="post" action="">
        ...
        <div class="element">
            ...
            <select name="Rstatus" id="loc_id">
                <option value="">---Select Registration Status--- </option>
                <?php
                $courseId = $_REQUEST['course'];
                foreach ($classRstatus as $key=>$value) {
                    ?>
                    <option value="<?php echo $key; ?>"   <?php if ($_REQUEST['Rstatus'] == $key) { ?>selected="selected"<?php } ?>><?php echo ucfirst($value); ?> </option>
                <?php } ?>
            </select>     
        </div>  

        <div class="element">
            <label>Select Registration Type For Search</label>
            <select name="Rtype" id="classCode" >
            
                <option value="">---Select Registration Type--- </option>                
                    <option value="internal"   <?php if ($_REQUEST['Rtype'] == "internal") { ?>selected="selected"<?php } ?>>Internal</option>
                     <option value="external"   <?php if ($_REQUEST['Rtype'] == "external") { ?>selected="selected"<?php } ?>>External</option>
            </select>     
        </div> 
        ...
        <table>
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col"><a href="itfmain.php?itfpage=class&actions=class_registration_list&col=loc_name_asc" class="arrow1">&nbsp;</a>Location Name<a href="itfmain.php?itfpage=class&actions=class_registration_list&col=loc_name_desc" class="arrow2">&nbsp;</a></th>
                    <th scope="col"><a href="itfmain.php?itfpage=class&actions=class_registration_list&col=course_asc" class="arrow1">&nbsp;</a>Course Name<a href="itfmain.php?itfpage=class&actions=class_registration_list&col=course_desc" class="arrow2">&nbsp;</a></th>
                    <th scope="col"><a href="itfmain.php?itfpage=class&actions=class_registration_list&col=start_date_asc" class="arrow1">&nbsp;</a>Start Date<a href="itfmain.php?itfpage=class&actions=class_registration_list&col=start_date_desc" class="arrow2">&nbsp;</a></th>
                    <th scope="col"><a href="itfmain.php?itfpage=class&actions=class_registration_list&col=end_date_asc" class="arrow1">&nbsp;</a>End Date<a href="itfmain.php?itfpage=class&actions=class_registration_list&col=end_date_desc" class="arrow2">&nbsp;</a></th>      
                    <th scope="col"><a href="itfmain.php?itfpage=class&actions=class_registration_list&col=day_of_week_asc" class="arrow1">&nbsp;</a>Day of WeeK<a href="itfmain.php?itfpage=class&actions=class_registration_list&col=day_of_week_desc" class="arrow2">&nbsp;</a></th>
                    <th scope="col"><a href="itfmain.php?itfpage=class&actions=class_registration_list&col=registration_type_asc" class="arrow1">&nbsp;</a>Registration Type<a href="itfmain.php?itfpage=class&actions=class_registration_list&col=registration_type_desc" class="arrow2">&nbsp;</a></th>
                    <th scope="col"><a href="itfmain.php?itfpage=class&actions=class_registration_list&actions=class_registration_list&col=registration_status_asc" class="arrow1">&nbsp;</a>Class Registration Status<a href="itfmain.php?itfpage=class&actions=class_registration_list&actions=class_registration_list&col=registration_status_desc" class="arrow2">&nbsp;</a></th>
                ...
                if (count($InfoData) > 0) {
                    for ($i = 0; $i < count($InfoData); $i++) {
                        ...
                        <tr>
                            ...
                            <td class="align-left">
                                <?php if($obj->getStudentStatus($InfoData[$i]['id'], 1)>0)
                                {
                                    ?>
                                
                                <a href="" onclick="popStudentListing('<?php echo SITEURL?>/index.php?itfpage=student&itemid=print_admin_student_listing&classId=<?php echo $InfoData[$i]['id'] ?>')"><?php
                                //echo //$obj->showAllCourseName($InfoData[$i]['course_id']);
                                echo $obj->getStudentStatus($InfoData[$i]['id'], 1);
                                ?>
                                </a>
                                <?php } else { echo $obj->getStudentStatus($InfoData[$i]['id'], 1);}?></td>
