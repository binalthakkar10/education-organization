/* Initial Version - 6/3/16 - Duplicate Class 
Version 1.1 - 6/17/16 - Enhancement 15 - Internal/External */
<?php
        ...
        <div class="element">
            ...
            <select name="course_id" id="course_code" class="err">
                ...
                <?php foreach ($course as $courseCode) { ?>
                    <option value="<?php echo $courseCode['id'] ?>">
                    <?php echo ucfirst($courseCode['code']) . ' - ' . $courseCode['name']; ?>
                    </option>
                        <?php } ?>
            </select>
        </div>   
