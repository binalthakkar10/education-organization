...
if(isset($_POST['itf_datasid'],$_POST['itfactions']))
{
	...
	if($acts=='delete')
	{
		$objfaculty->adminDelete($ids);
		flash("Session is successfully Deleted");
	}
...
<input type="hidden" name="itf_status" id="itf_status" value="" />
  <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <th width="78%" align="left"  >Title </th>
   ...
   <td align="center">
   <a href="<?php echo CreateLinkAdmin(array($currentpagenames,'actions'=>'edit','id'=>$itfdata['id'])); ?>" title="Edit Category " alt="Edit Category"><img src="imgs/itf_edit.png" border="0" /></a> 
   </td>
    </tr>
	<?php
	}
