...
$courobj = new Course();
if ($_GET['show'] == 'all') {
    $InfoData1 = $obj->showAllSummerCampList(false, $_REQUEST);
} else {
    $InfoData1 = $obj->showAllSummerCampList(true, $_REQUEST);
}
        ...
        <table>
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col"><a href="itfmain.php?itfpage=summer_camp&col=loc_name_asc" class="arrow1">&nbsp;</a>Location Name<a href="itfmain.php?itfpage=summer_camp&col=loc_name_desc" class="arrow2">&nbsp;</a></th>
                    <th scope="col"><a href="itfmain.php?itfpage=summer_camp&col=course_asc" class="arrow1">&nbsp;</a>Course Name<a href="itfmain.php?itfpage=summer_camp&col=course_desc" class="arrow2">&nbsp;</a></th>
                    <th scope="col"><a href="itfmain.php?itfpage=summer_camp&col=start_date_asc" class="arrow1">&nbsp;</a>Start Date<a href="itfmain.php?itfpage=summer_camp&col=start_date_desc" class="arrow2">&nbsp;</a></th>
                    <th scope="col"><a href="itfmain.php?itfpage=summer_camp&col=end_date_asc" class="arrow1">&nbsp;</a>End Date<a href="itfmain.php?itfpage=summer_camp&col=end_date_desc" class="arrow2">&nbsp;</a></th>      
                    <th scope="col"><a href="itfmain.php?itfpage=summer_camp&col=day_of_week_asc" class="arrow1">&nbsp;</a>Day of WeeK<a href="itfmain.php?itfpage=summer_camp&col=day_of_week_desc" class="arrow2">&nbsp;</a></th>
