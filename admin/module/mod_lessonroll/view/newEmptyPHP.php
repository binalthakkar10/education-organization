...
.................................
 ...
 <td width="17%"><div class="table_student_name">Alex Ritz</div></td>
            <td width="17%">
            ...
            <td width="17%"><select name="select2" id="select2">
              <option>Present</option>
              <option>Absent</option>
            </select></td>
            <td width="17%"><select name="select3" id="select3">
              <option>Present</option>
              <option>Absent</option>
            </select></td>
            <td width="17%"><select name="select4" id="select4">
              <option>Present</option>
              <option>Absent</option>
            </select></td>
            <td width="17%"><select name="select5" id="select5">
              <option>Present</option>
              <option>Absent</option>
            </select></td>
        ...
        {
         //
                $datas['teacher_id'] = $_SESSION['LoginInfo']['USERID'];
             //echo "<pre>" ; print_r($datas); echo "</pre>"; 
                 //print_r($datas['roll_call'][$datas['student_id']]);die();
            foreach ($datas as $datas){$flag=0;
                 echo "<pre>" ; print_r($datas); echo "</pre>";       
            
                $attandance['student_id'] = $datas['student_id'];
                $attandance['attand_date'] = date("Y-m-d H:i:s",time());
                
                if($datas['roll_call']=='Absent'){
                $attandance['roll_call'] = $datas['roll_call'];$flag=1;
                }
                if($datas['period1']=='Absent'){
                $attandance['period1'] = $datas['period1'];$flag=1;
                }
                if($datas['period2']=='Absent'){
                $attandance['period2'] = $datas['period2'];$flag=1;
                }
                if($datas['period3']=='Absent'){
                $attandance['period3'] = $datas['period3'];$flag=1;
                }
                if($datas['period4']=='Absent'){
                $attandance['period4'] = $datas['period4'];$flag=1;
                }
                if($datas['period5']=='Absent'){
                $attandance['period5'] = $datas['period5'];$flag=1;
                }           
            if($flag==1){    
