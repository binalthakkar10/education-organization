...
$InfoData1 = $obj->showAllGrade($parentids);
                ...
                for($i=0;$i<count($InfoData);$i++)
                {
                    ...
                    <tr>
                        <td class="align-center"><input name="itf_datasid[]" type="checkbox" value="<?php echo $InfoData[$i]['id']; ?>" class="itflistdatas"/></td>
                         <td class="align-center"><?php echo $InfoData[$i]['grade']; ?></td>
                          <td class="align-center"><?php echo $InfoData[$i]['grade_desc']; ?></td>                 
                        <td class="align-center">
                            <a href="#itf" class="activations" rel="<?php echo $InfoData[$i]['id']; ?>" rev="frmgrade"><img src="imgs/<?php echo $InfoData[$i]['status']; ?>.png" /></a>
                        </td>
                        <td class="align-center">
