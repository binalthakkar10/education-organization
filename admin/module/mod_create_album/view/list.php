...
if(isset($_POST['itf_datasid']))
{
	...
	$ids=implode(',',$_POST['itf_datasid']);
                 if($acts=='delete'){
                      ...
                      $check=$obj->CheckAlbum($ids);
                      //$folderName=$check[$ids];
                      $obj->deleteFolder($ids);
                      $obj->Album_deleteAdmin($ids);
...
$InfoData1 = $obj->showAllAlbum($parentids);
    ...
    <form id="itffrmlists" name="itffrmlists" method="post" action="">
        ...
        <table>
            ...
            <tr>
              ...
              <th scope="col" style="width: 65px;">View</th>
            </tr>
            </thead>
            <tbody>
            <?php
                ...
                for($i=0;$i<count($InfoData);$i++)
                {
                    ...
                    <tr>
                        <td class="align-center"><input name="itf_datasid[]" type="checkbox" value="<?php echo $InfoData[$i]['id']; ?>" class="itflistdatas"/></td>
                         <td class="align-left"><?php echo $InfoData[$i]['album_name']; ?></td>
                         <td class="align-left"><?php echo $InfoData[$i]['album_desc']; ?></td>             
                        ...
                        <td class="align-center">
                         ...
                         <td class="align-center">
                            <a href="<?php echo CreateLinkAdmin(array('gallery','gid'=>$InfoData[$i]['id'])); ?>" title="view <?php echo $pagetitle; ?> " alt="view <?php echo $pagetitle; ?>"><img src="img/view.png" border="0" /></a> &nbsp;
                            <?php /* if($parentids==0){ ?>
                               <a href="<?php echo CreateLinkAdmin(array($currentpagenames,"parentid"=>$InfoData[$i]['id'])); ?>" title="Add City " alt="Add City "><img src="img/add_city.png" border="0" class="city" /></a>
                            <?php }  */ ?>
                        </td>
