    ...
    <form action="" method="post" name="itffrminput" id="itffrminput" enctype="multipart/form-data">
        ...
        <div class="element">
		 ...
		 <div class="element">
            ...
            <input class="field size1"  name="secondary_phone" type="text"  id="secondary_phone" size="35" value="<?php if($InfoData['secondary_phone']!="" && $InfoData['secondary_phone']!='0'){echo $InfoData['secondary_phone'];} ?>" maxlength="50"/>
        </div>
