...
<div class="full_w">
 ...
 <div class="element">
            <label>Area Title<span class="red">(required)</span></label>
            <input class="field size1"  name="area_title" type="text"  id="area_title" size="35" value="<?php echo isset($InfoData['area_title'])?$InfoData['area_title']:'' ?>" />
        </div>
